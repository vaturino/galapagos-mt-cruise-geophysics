"""
Vendored from SciPy's scipy.io._netcdf module (BSD-3-Clause license,
Copyright (c) SciPy Developers), unmodified, so that the mosaic script in
this folder works on this machine without needing `pip install scipy`
(which needs internet access this Mac may not have). Only depends on
numpy + the Python standard library. Upstream:
https://github.com/scipy/scipy/blob/main/scipy/io/_netcdf.py
